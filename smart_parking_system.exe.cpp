...
public:
    ...
    void vehicleEntry() {
        ...
        if (availableSlots() == 0) {
            cout << "Sorry, the parking lot is full.\n";
            return;
        }
    ...
    void vehicleExit() {
        ...
        cout << "PARKING BILL\n";
        cout << "Plate number: " << vehicle.plateNumber <<"\n";
        cout << "Owner: " << vehicle.ownerName <<"\n";
        cout << "Slot: " << vehicle.slotNumber <<"\n";
        cout << "Entry time: "
             << formatTime(vehicle.entryTime) <<"\n";
        cout << "Exit time: "
             << formatTime(exitTime) <<"\n";
        cout << "Time spent: " << hours << " hour(s)" <<"\n";
        cout << "Billable hours: " << billableHours <<"\n";
        cout << "Amount to pay: KSh " << amount <<"\n";
...
int main() {
    ...
    do {
        ...
        switch (choice) {
            ...
            case 0:
                cout << "Thank you for using the Smart Parking System.\n";
                break;
